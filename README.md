...
Ver 2.33  
[=] Оптимизирован процесс получения информации о ПК (+скорость и не должно крашить на особенных пк где WMI не может получить информацию о компе)  
[=] При возникновении ошибок в программе она больше не будет закрываться  
[+] При отсутствии браузера по умолчанию, программа теперь не будет выдавать ошибку, а напомнит пользователю выбрать браузер по умолчанию.  
[=] Скорректировано отключение некоторых твиков при отсутствии интернета  
[=] Добавлена буферизация панелей, теперь багов в анимациях должно быть меньше  

Ver 2.32  
[=] Исправлен краш при восстановлении защитника  
[+] Добавлены анимации при наведении на вкладки программы  
[+] По результатам голосования добавлена анимация перехода между вкладками  
[+] Добавлена возможность отключить анимацию перехода (Интерфейс - 2 вкладка)  
[=] Исправлен фриз при открытии вкладки GPU  
[=] Настройка Nvidia Profile Inspector была перенесена в вкладку GPU  
[=] Настройка Nvidia Profile Inspector и расширенная очистка были переведены из CheckBox в обычный Label.  
